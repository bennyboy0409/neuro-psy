...
export const fragenGeneriert: Frage[] = [
  ...
  },
  {
    ...
    aussagen: [
      ...
      { text: "Theorien müssen prinzipiell widerlegbar (falsifizierbar) sein.", istRichtig: true },
      { text: "Der 'gesunde Menschenverstand' reicht als wissenschaftlicher Beleg.", istRichtig: false },
      { text: "Introspektion allein gilt heute als ausreichende wissenschaftliche Methode.", istRichtig: false },
    ],
    erklaerung: "Empirisch heißt: ==an Daten prüfbar== (a) und ==falsifizierbar== (b). Alltagswissen ist kein Beleg (c falsch), und reine ==Introspektion== gilt heute nicht als ausreichend (d falsch).",
    merksatz: "Empirisch = ==an Daten prüfbar== + ==falsifizierbar== (nicht Bauchgefühl).",
  },
  {
    id: "G1-3", teil: "A", kapitel: 1, thema: "Ethik", quelle: "generiert", schwierigkeit: 2,
    stem: "Welche Aussagen zur ==Forschungsethik== sind korrekt?",
    aussagen: [
      { text: "Teilnehmende müssen vorab aufgeklärt werden und freiwillig zustimmen.", istRichtig: true },
      { text: "Eine Täuschung der Teilnehmenden ist grundsätzlich immer verboten.", istRichtig: false },
      { text: "Nach einer Täuschung ist eine Aufklärung (Debriefing) nötig.", istRichtig: true },
      { text: "Daten sind vertraulich zu behandeln (Anonymität, Datenschutz).", istRichtig: true },
    ],
    erklaerung: "Zentrale Regeln: ==informierte Einwilligung== (a), ==Debriefing== nach Täuschung (c) und ==Vertraulichkeit== (d). Täuschung ist unter strengen Bedingungen erlaubt, nicht generell verboten (b falsch).",
    merksatz: "Ethik: ==Einwilligung==, nach Täuschung ==Debriefing==, immer ==Vertraulichkeit==.",
  },
  ...
  // ---------- Kapitel 6 ----------
  {
    ...
    aussagen: [
      { text: "Objektpermanenz entwickelt sich im sensomotorischen Stadium.", istRichtig: true },
      { text: "Im präoperatorischen Stadium ist das Denken oft egozentrisch.", istRichtig: true },
    ...
    erklaerung: "Objektpermanenz = sensomotorisch (a), Egozentrismus = präoperatorisch (b), Erhaltung = konkret-operatorisch (c). Abstrakt-hypothetisches Denken kommt erst im ==formal-operatorischen== Stadium (d falsch).",
  ...
  },
  {
    ...
    aussagen: [
      ...
      { text: "Konformität nimmt zu, wenn eine einstimmige Mehrheit vorliegt.", istRichtig: true },
      { text: "Ein einziger abweichender Verbündeter reduziert die Konformität deutlich.", istRichtig: true },
      { text: "Gehorsam gegenüber Autorität war bei Milgram die Ausnahme (unter 10 %).", istRichtig: false },
    ],
    erklaerung: "Bei Milgram gingen ==~65 %== bis 450 V (a) — also keine Ausnahme (d falsch). Konformität steigt bei einstimmiger Mehrheit (b) und sinkt stark durch einen ==Abweichler== (c).",
    merksatz: "Milgram ==~65 %== bis zum Ende; ein ==Abweichler== senkt Konformität stark.",
  },
  {
    id: "G7-3", teil: "A", kapitel: 7, thema: "Attribution", quelle: "generiert", schwierigkeit: 3,
    stem: "Welche Aussagen zur ==Attribution== sind korrekt?",
    aussagen: [
      { text: "Beim fundamentalen Attributionsfehler wird Verhalten anderer zu stark der Person zugeschrieben.", istRichtig: true },
      { text: "Dabei wird der Einfluss der Situation unterschätzt.", istRichtig: true },
      { text: "Interne Attribution führt Verhalten auf äußere Umstände zurück.", istRichtig: false },
      { text: "Beim selbstwertdienlichen Bias schreibt man eigene Erfolge internal, Misserfolge external zu.", istRichtig: true },
    ],
    erklaerung: "Fundamentaler Attributionsfehler: Person überschätzen (a), Situation unterschätzen (b). ==Interne== Attribution meint die ==Person/Disposition==, nicht äußere Umstände (c falsch). Der selbstwertdienliche Bias ist korrekt beschrieben (d).",
    merksatz: "==intern = Person==, ==extern = Situation==; Attributionsfehler: Person über-, Situation unterschätzt.",
  },
  {
  ...
  },
  {
    ...
    aussagen: [
      ...
      { text: "Fragebögen zur Selbstbeschreibung zählen zu den objektiven/psychometrischen Verfahren.", istRichtig: true },
      { text: "Das MMPI ist ein projektives Verfahren.", istRichtig: false },
      { text: "Ein Intelligenztest ist ein Leistungstest.", istRichtig: true },
    ],
    erklaerung: "Projektiv = mehrdeutig (a), Fragebögen = objektiv/psychometrisch (b), Intelligenztest = Leistungstest (d). Das ==MMPI== ist ein ==Fragebogen==, kein projektives Verfahren (c falsch).",
    merksatz: "==Projektiv== = mehrdeutig (Rorschach/TAT); ==MMPI/Fragebögen== = objektiv.",
  },
  {
    ...
    aussagen: [
      ...
      { text: "Ein Test kann voll valide sein, ohne reliabel zu sein.", istRichtig: false },
    ],
    erklaerung: "Objektivität = unabhängig vom Testleiter (a), Reliabilität = genau (b), Validität = misst das Richtige (c). ==Reliabilität ist Voraussetzung für Validität== — ohne Zuverlässigkeit keine Gültigkeit (d falsch).",
    merksatz: "==Objektivität → Reliabilität → Validität==; ohne Reliabilität keine Validität.",
  },
];
